...
function abrirModalAutor(idAutor) {
  ...
  arregloAutores.forEach((element) => {
    ...
    if (element.idAutor == idAutor) {
      ...
      contenidoModal.innerHTML +=
        '<h3>Datos del Autor</h3><table class="table table-bordered ">' +
        "<tr><td> Id:</td><td> " +
        element.idAutor +
        "</td></tr>" +
        "<tr><td> Nombre: </td><td>" +
...
function abrirModalEditorial(idEditorial) {
  ...
  arregloEditoriales.forEach((element) => {
    ...
    if (element.idEditorial == idEditorial) {
      ...
      contenidoModalE.innerHTML +=
        '<h3>Datos de la Editorial</h3><table class="table table-bordered ">' +
        "<tr><td> Id:</td><td>" +
        element.idEditorial +
        "</td></tr>" +
        "<tr><td> Nombre:</td> <td>" +
        element.nombreEditorial +
        "</td></tr>" +
        "</table> ";
    }
  });
...
function confirmAccion(idLibro) {
  Swal.fire({
